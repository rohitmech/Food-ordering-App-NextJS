  ...
  return (
    <div className='bg-black h-screen flex flex-col md:flex-row md:justify-between md:bg-[url("/offerBg.png)] md:h-[70vh]'>
      ...
      <div className='flex-1 flex flex-col items-center justify-center text-center gap-8 p-6'>
        ...
        process centric methods of empowerment. 
        Quickly pontificate parallel</p>
        <CountDown/>
        <button className='bg-red-500 px-6 py-3 text-white rounded-md font-bold'>Order Now</button>
